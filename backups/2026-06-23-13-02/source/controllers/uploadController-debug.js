...
console.log('=== DEBUG uploadController.js ===');
console.log('prisma imported:', typeof prisma);
console.log('prisma.workPhoto exists:', 'workPhoto' in prisma);
console.log('prisma.workPhoto type:', typeof prisma.workPhoto);
...
async function getWorks(req, res) {
  console.log('=== DEBUG getWorks function ===');
  console.log('prisma in getWorks:', typeof prisma);
  console.log('prisma.workPhoto in getWorks:', typeof prisma.workPhoto);
